...
INSERT INTO "new_FavoritesFilm" ("created_at", "film_id", "film_poster", "film_title", "id", "plugin", "plugin_name", "updated_at") SELECT "created_at", "film_id", "film_poster", "film_title", "id", "plugin", "plugin_name", "updated_at" FROM "FavoritesFilm";
